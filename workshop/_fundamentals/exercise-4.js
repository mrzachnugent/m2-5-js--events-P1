// Exercise 4
//
// 1. Write a function that accepts an array of objects and a key (string) as arguments
//    and returns a  new array with only the values of the corresponding key.
//
